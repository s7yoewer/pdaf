...
!        ONLY: nx, ny, nx_p
  ...
  USE obs_GRACE_pdafomi, &            ! Variables for observation type A
    ONLY: assim_GRACE

  USE obs_SM_pdafomi, &            ! Variables for observation type A
    ONLY: assim_SM

  use enkf_clm_mod, only: clmupdate_tws, clmupdate_swc
  ! kuw end
...
! *** This is optional, but useful ***
  ...
  ! Initialize omi observations --> take what was parsed in enkfpf.par and set the things to true
